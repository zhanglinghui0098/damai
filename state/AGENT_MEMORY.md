...
> **最后更新**: 2026-06-28 03:50 CST (由 Hermes 跟 user 06-28 凌晨对齐, **注意内测剩 < 2 天不是 3.5 天**)
...
**接下来**: **06-30 内测** (3.5 天) → **07-15 公测** (2.5 周)。
...
## 3. 内测 06-30 必预先 (**< 2 天剩余**, 砍到 3 件 0 号阻塞)
...
⚠️ **如果 SMS 审核慢, 推到 07-01 周三** (B 方案, 多 1 天, 更稳)

## 4. 公测 07-15 必预先 (2.5 周, 5 件事 + ECS 升配必须 07-10)

| # | 必做 | 估时 | 谁 | 阻塞 |
|---|---|---|---|---|
| 1 | **2.1 飞书项目表** (推到 07-01) | 1 天 | 我 | 等内测 06-30 完成 |
